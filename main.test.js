...
// // Test 2
// test("2 - should handle duplicates in an array", () => {
//     // Arrange
//     // Variables - an array of faithfuls and a string representing the murdered faithful
...
// //Test 3
// test("3 - should be case insensitive when removing the murdered faithful", () => {
//     // Arrange
//     // Variables - an array of faithfuls and a string representing the murdered faithful
//     const faithfuls = ["Leanne", "livi", "Tyler", "Kas", "Jake"]
//     const murdered = "LIVI"
...
//Test 4
// test("4 - should handle arrays with null values", () => {
//     // Arrange
//     // Variables - an array of faithfuls and a string representing the murdered faithful
